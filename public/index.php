...
use BlueHR\Controllers\LeaveTypeController;
...
$r->get('/leave',[LeaveController::class,'index']); $r->get('/leave-types',[LeaveTypeController::class,'index']); $r->get('/leave-types/create',[LeaveTypeController::class,'create']); $r->post('/leave-types/store',[LeaveTypeController::class,'store']); $r->get('/leave-types/edit',[LeaveTypeController::class,'edit']); $r->post('/leave-types/update',[LeaveTypeController::class,'update']); $r->post('/leave-types/delete',[LeaveTypeController::class,'delete']); $r->post('/leave/store',[LeaveController::class,'store']); $r->post('/leave/approve',[LeaveController::class,'approve']); $r->get('/leave/settings',[ModuleController::class,'leaveSettings']);
