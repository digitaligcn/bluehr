...
$r->get('/reports',[OperationalController::class,'reports']); $r->get('/settings',[ModuleController::class,'settings']); $r->post('/settings/save',[ModuleController::class,'saveSettings']); $r->post('/settings/record/store',[ModuleController::class,'storeSettingRecord']);
$r->dispatch();
